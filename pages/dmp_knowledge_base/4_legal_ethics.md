...
1. Ensure that when dealing with personal data data protection laws (for example GDPR) are complied with:
2. Gain informed consent for preservation and/or sharing of personal data.
3. Consider anonymisation of personal data for preservation and/or sharing (truly anonymous data are no longer considered personal data).
4. Consider pseudonymisation of personal data (the main difference with anonymisation is that pseudonymisation is reversible).
5. Consider encryption which is seen as a special case of pseudonymisation (the encryption key must be stored separately from the data, for instance by a trusted third party).
6. Explain whether there is a managed access procedure in place for authorized users of personal data.

### [FAIRsFAIR Additional Guidance](https://doi.org/10.5281/zenodo.6088215)
For guidance on access, see 5a.
 
--- 
 ### Relevant when in the project:
pre-award
post-award

### Responsible for providing information:
- Project owner
- Possibly ITA, DPO or legal experts
...
Commetn to Guidance from NFR 3. below: encryption is not sustainable for long term preservation <!--egen kommentar, vurder om dette skal diskuteres LK->
...
2. Is informed consent for long-term preservation and possibly sharing of personal data used?
3. Is anonymization, pseudonymization or encryption of personal data being considered for long-term preservation and/or sharing?
4. Should a managed procedure be used for authorized access to personal data?
...
### [SND Checklist for Data Management Plan] (https://zenodo.org/records/6424769) [&] (https://snd.gu.se/en/manage-data/plan/data-management-plan)
...
- anonymization
- behandlingsgrunnlag /legal basis for processing of personal data
consent
...
<!--additional explanations-->
### Explanations for support staff
burde andre legal issues nevnes eksplisit under egne punkter, slik at dette handler om opphavsrett? eg. eksport kontroll
...
- Project owner
- Data steward
- Possibly contribution from collaborator
- Core facility
...
#### [DMPTuuli =General Finnish DMP guidance] (https://zenodo.org/records/5242629) 
...
E.g. human participants/samples (Helsinki declaration, REK approval), animal experiments (3R principles, FOTS), data reuse considerations (CARE principles, data use ontology)

---
<!--recycling possible?-->
### Existing sources that can be reused
#### [Covered in RDA maDMP common std] (http://doi.org/10.15497/rda00039) [FAQ] (https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard/blob/master/docs/FAQ.md)

Properties in dmp: https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#ethical_issues_description_tree https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#ethical_issues_exist_tree https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard#ethical_issues_report_tree
